...
export default function HeroSectionProfessional() {
        ...
        <div className="mb-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button
              ...
              className="px-8 py-3 text-base font-semibold text-gray-700 transition-all duration-300 bg-white border-2 border-gray-300 rounded-lg hover:border-cyan-600 hover:text-cyan-600 hover:-translate-y-0.5"
            >
  ...
  className="!w-[85vw] sm:!w-[70vw] md:!w-[600px] lg:!w-[750px]"
>
  {({ isActive }) => (
    <div
      className={`relative w-full overflow-hidden transition-all duration-700 rounded-2xl group ${
    ...
    >
      <div className="relative aspect-video">
        ...
        {/* Text Content */}
        <div
          className={`absolute inset-0 flex flex-col justify-end p-6 md:p-8 transition-all duration-700 ${
        ...
        >
          ...
          <p className="max-w-xl text-sm text-gray-200 md:text-base">
            {slide.deskripsi}
              ...
              {/* Fade kiri & kanan */}
              <div className="absolute inset-y-0 left-0 z-10 w-24 pointer-events-none bg-gradient-to-r from-cyan-50 via-white/60 to-transparent"></div>
              <div className="absolute inset-y-0 right-0 z-10 w-24 pointer-events-none bg-gradient-to-l from-cyan-50 via-white/60 to-transparent"></div>
            </>
          )}
        </div>
